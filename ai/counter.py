...
# Remote videostream
# python remote_zmq.py --input remote --webserver 192.168.178.31
...
ap.add_argument("-p", "--prototxt", type=str, default="resources/MobileNetSSD_deploy.prototxt",
    ...
    if totalFrames % args["skip_frames"] == 0:
        ...
        for i in np.arange(0, detections.shape[2]):
            ...
            if confidence > args["confidence"]:
                ...
                rect = dlib.rectangle(int(startX), int(
...
# in case of a remote video source, shut down the server
else:
    if args["input"] != "remote":
        vs.release()
    else:
